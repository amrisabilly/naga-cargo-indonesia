                    ...
                    <table id="example" class="display" style="overflow-x: scroll;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">{{ $kurir->nama }}</td>
                                <td style="text-align: center">
                                    <div class="credential-item">
                                        <span class="credential-text text-[#879FFF] font-semibold">{{ $kurir->username
                                            }}</span>
                                ...
                                <td style="text-align: center">{{ $kurir->no_hp }}</td>
                                <td style="text-align: center">{{ $kurir->daerah->nama ?? 'N/A' }}</td>
                                <td style="text-align: center">
                                    <span
                                ...
                                <td style="text-align: center" class="flex flex-row justify-center gap-2">
                                    ...
                                    <button type="button" onclick="openDeleteModal('{{ $kurir->id_user }}', '{{ $kurir->nama }}')"
                    ...
                    <div id="deleteModal"
                        ...
                        <div class="w-full max-w-md rounded-lg bg-white p-6 text-center">
                            ...
                            <h3 class="mb-2 text-lg font-medium leading-6 text-gray-900" id="modal-title">Konfirmasi
                                Hapus</h3>
                            <p class="mb-2 text-base text-gray-700 font-semibold" id="deleteUserName"></p>
