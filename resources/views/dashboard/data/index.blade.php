                    ...
                    <table id="dataPengirimanTable" class="w-full">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-3 py-4 text-sm text-gray-900">Jakarta</td>
                                <td class="px-3 py-4">
                                    <span
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-3 py-4">
                                    <span class="text-sm font-semibold text-[#879FFF]">PKG002</span>
                                </td>
                                <td class="px-3 py-4 text-sm text-gray-900" title="Alice Johnson">Alice Johnson</td>
                                <td class="px-3 py-4 text-sm text-gray-900" title="Bob Wilson">Bob Wilson</td>
                                <td class="px-3 py-4 text-sm text-gray-900">Surabaya</td>
                                <td class="px-3 py-4">
                                    <span
                                ...
                                <td class="px-3 py-4 text-sm text-gray-900">16 Jan 2024</td>
                                <td class="px-3 py-4 text-center">
                                    <div class="flex justify-center gap-1">
                                        {{-- <button
                                            class="p-1.5 text-blue-600 hover:text-blue-900 hover:bg-blue-50 rounded-lg transition-colors"
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-3 py-4">
                                    <span class="text-sm font-semibold text-[#879FFF]">PKG003</span>
                                </td>
                                <td class="px-3 py-4 text-sm text-gray-900" title="David Brown">David Brown</td>
                                <td class="px-3 py-4 text-sm text-gray-900" title="Sarah Davis">Sarah Davis</td>
                                <td class="px-3 py-4 text-sm text-gray-900">Bandung</td>
                                <td class="px-3 py-4">
                                    <span
                                ...
                                <td class="px-3 py-4 text-sm text-gray-900">17 Jan 2024</td>
                                <td class="px-3 py-4 text-center">
                                    <div class="flex justify-center gap-1">
                                        {{-- <button
                                            class="p-1.5 text-blue-600 hover:text-blue-900 hover:bg-blue-50 rounded-lg transition-colors"
