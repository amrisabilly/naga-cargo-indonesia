            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="info-card">
                    <div class="info-row">
                        ...
                        <span class="info-value">AWB: {{ $order->AWB }}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Tanggal Kirim</span>
                        <span class="info-value">{{ $order->tanggal_kirim }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 h-fit">
                ...
                <div class="gallery-container">
                    ...
                    <div class="main-image" onclick="openModal(0)">
                        <img id="mainImage"
                            src="{{ $fotos->first()->path_foto ?? 'https://picsum.photos/150/150' }}"
                    ...
                    <div class="thumbnail-grid">
                        ...
                        <div class="thumbnail{{ $i == 0 ? ' active' : '' }}" onclick="changeMainImage({{ $i }}, this)">
...
<script>
    // Data foto dari backend
        ...
        function changeMainImage(index, thumbnail) {
            ...
            document.getElementById('mainImage').src = images[index]?.url || 'https://via.placeholder.com/600x400?text=No+Image';
        ...
        function openModal(index) {
            ...
            currentImageIndex = index;
            document.getElementById('modalImage').src = images[index]?.url || 'https://via.placeholder.com/600x400?text=No+Image';
        ...
        function prevImage() {
            ...
            document.getElementById('modalImage').src = images[currentImageIndex]?.url || 'https://via.placeholder.com/600x400?text=No+Image';
